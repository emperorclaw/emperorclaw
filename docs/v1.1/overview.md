...
- **Finance folders** – The finance workspace lives under `artifacts/your-org/YYYY/YYYY-MM/{expenses,invoices,statements}` so reports upload to canonical paths, enabling consistent billing/reporting references.
