...
- Reuse projects by outcome. The goal is its displayed name: use 3–8 words, preferably under 80 characters; put background and success criteria in memory/tasks. Create bounded tasks with acceptance criteria and explicitly assign trackable work; a chat mention alone is not assignment.
