    ...
    return (
        <div className="mx-auto max-w-[1400px] space-y-6 animate-in fade-in duration-500">
            <PageHeader
                eyebrow="Finance"
                title="Budget & Usage"
                description="Click any limit or model to edit inline. Budgets auto-enforce: warning at 80%, pause at 100%."
            />
            <BudgetClient initialAgents={allAgents} initialPricing={pricing} />
        </div>
    );
}
